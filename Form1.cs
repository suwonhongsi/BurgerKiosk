...
namespace BurgerKiosk
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            hamburger.CheckedChanged += Selection_Changed;
            bulgogi.CheckedChanged += Selection_Changed;
            chicken.CheckedChanged += Selection_Changed;
            fried.CheckedChanged += Selection_Changed;
            coke.CheckedChanged += Selection_Changed;
            cheese.CheckedChanged += Selection_Changed;
            source.CheckedChanged += Selection_Changed;
        }
        ...
        private void UpdateOrder()
        {
            ...
            if (hamburger.Checked) { totalCost += 5000; list.Items.Add("햄버거 5,000원"); }
            else if (bulgogi.Checked) { totalCost += 4000; list.Items.Add("불고기버거 4,000원"); }
            else if (chicken.Checked) { totalCost += 3000; list.Items.Add("치킨버거 3,000원"); }
